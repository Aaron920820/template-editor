$.fn.extend({
	l_zoom: function(c) {
		...
		var b = $('<div class="zoom_right border_all"></div><div class="zoom_rotate border_all"><i class="sync mini icon" style="font-size:12px"></i></div>');
		var x = $('<div class="zoom_right border_all"></div><div class="zoom_bottom border_all"></div><div class="zoom_rb border_all"></div><div class="zoom_rotate border_all"><i class="sync mini icon" style="font-size:12px"></i></div>');
